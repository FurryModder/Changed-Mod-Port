...
public class MixedStateProvider extends BlockStateProvider {
    public static final MapCodec<MixedStateProvider> CODEC = WeightedEntry.Wrapper.codec(BlockStateProvider.CODEC).listOf().fieldOf("entries").xmap(MixedStateProvider::new, MixedStateProvider::unwrap);
    ...
    public BlockState getState(RandomSource random, BlockPos blockPos) {
        ...
        return WeightedRandom.getWeightedItem(this.items, i).get().data().getState(random, blockPos);
    }
