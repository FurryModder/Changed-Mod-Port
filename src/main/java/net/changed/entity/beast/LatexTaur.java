...
public interface LatexTaur<T extends ChangedEntity> extends Saddleable {
    ...
    default void equipSaddle(T self, ItemStack stack, @Nullable SoundSource p_21748_) {
        self.getPersistentData().put(SADDLE_LOCATION, (new ItemStack(Items.SADDLE)).saveOptional(self.registryAccess()));
        if (p_21748_ != null) {
