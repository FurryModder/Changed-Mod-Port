...
public class CustomLatexEntity extends ChangedEntity implements LatexTaur<CustomLatexEntity>, ModifiableEntity {
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        builder.define(DATA_FORM_FLAGS, 0);
    }
    ...
    protected void setAttributes(AttributeMap attributes) {
        ...
        attributes.getInstance(net.minecraft.world.entity.ai.attributes.Attributes.STEP_HEIGHT).setBaseValue(computeStepHeightOffset(0.7));
    ...
    public void equipSaddle(ItemStack stack, @Nullable SoundSource source) {
        this.equipSaddle(this, stack, source);
    }
