...
public class FeralShark extends AbstractAquaticEntity {
    ...
    protected void setAttributes(AttributeMap attributes) {
        ...
        attributes.getInstance(NeoForgeMod.SWIM_SPEED).setBaseValue(5.0D);
        attributes.getInstance(net.minecraft.world.entity.ai.attributes.Attributes.STEP_HEIGHT).setBaseValue(computeStepHeightOffset(0.2));
    }
