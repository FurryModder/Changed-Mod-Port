...
public class HairStyle {
    ...
    public static final DeferredHolder<HairStyle, HairStyle> BALD = REGISTRY.register("bald",
            with(Collection.MALE));
    public static final DeferredHolder<HairStyle, HairStyle> LONG_MESSY = REGISTRY.register("long_messy",
            with(Collection.FEMALE, Changed.modResource("textures/hair/long_messy.png")));
    public static final DeferredHolder<HairStyle, HairStyle> SHORT_MESSY = REGISTRY.register("short_messy",
            with(Collection.MALE, Changed.modResource("textures/hair/short_messy.png")));
    public static final DeferredHolder<HairStyle, HairStyle> LONG_KEPT = REGISTRY.register("long_kept",
