...
import net.changed.block.LaserEmitterBlock;
...
public class EmittedLaser extends Entity {
    ...
    public void checkShapeAndApplyEffects() {
        ...
        if (!entities.isEmpty()) {
            ...
            var reactiveItems = ItemUtil.getWearingItems(effectedEntity, itemStack -> itemStack.getItem() instanceof LaserReactiveItem).toList();
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        builder.define(DATA_EMITTER_POS_ID, BlockPos.ZERO);
        builder.define(DATA_DIRECTION_ID, Direction.NORTH);
        builder.define(DATA_LENGTH_ID, 0f);
    }
