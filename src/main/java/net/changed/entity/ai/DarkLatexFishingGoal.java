...
public class DarkLatexFishingGoal extends MoveToBlockGoal {
    ...
    public boolean canUse() {
        ...
        if (entity.getCurrentFavor() != DarkLatexFavor.FISHING)
            return false;
        if (!entity.getMainHandItem().is(Tags.Items.TOOLS_FISHING_ROD))
            return false;
    ...
    protected void retrieveCast() {
        ...
        int luck = EnchantmentHelper.getFishingLuckBonus((ServerLevel)this.level, itemstack, entity);
        LootParams lootparams = (new LootParams.Builder((ServerLevel)this.level))
                .withParameter(LootContextParams.ORIGIN, Vec3.atCenterOf(targetWaterSurface))
                .withParameter(LootContextParams.TOOL, itemstack)
                .withParameter(LootContextParams.ATTACKING_ENTITY, entity)
