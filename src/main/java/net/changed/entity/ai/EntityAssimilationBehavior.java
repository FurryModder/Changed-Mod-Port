...
import net.changed.network.packet.AssimilatedEntitySyncPacket;
...
import static net.changed.init.ChangedGameRules.RULE_KEEP_BRAIN;
...
public interface EntityAssimilationBehavior<T extends LivingEntity> {
        ...
        public void assimilate(T entity) {
            ...
            var assimilateGoal = new MeleeAttackGoal(entity, speedModifier, followingTargetEvenIfNotSeen) {
                ...
                protected void checkAndPerformAttack(@NotNull LivingEntity target) {
                    ...
                    if (behavior != null && this.canPerformAttack(target)) {
    ...
    static <T extends LivingEntity, V extends ChangedEntity> EntityAssimilationBehavior<T> uniqueVariant(DeferredHolder<TransfurVariant<?>, TransfurVariant<V>> variant) {
        return uniqueVariant(variant, (oldEntity, newEntity) -> {});
    }

    static <T extends LivingEntity, V extends ChangedEntity> EntityAssimilationBehavior<T> uniqueVariant(DeferredHolder<TransfurVariant<?>, TransfurVariant<V>> variant, BiConsumer<T, IAbstractChangedEntity> traitMapper) {
        return new ReplaceSelfWithVariant<>(variant, traitMapper);
    }
