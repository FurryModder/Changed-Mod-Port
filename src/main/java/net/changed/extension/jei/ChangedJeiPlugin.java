package net.changed.extension.jei;
...
public class ChangedJeiPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        registration.addRecipes(infuserRecipeCategory.getRecipeType(), recipeManager.getAllRecipesFor(ChangedRecipeTypes.INFUSER_RECIPE.get()).stream()
                .map(holder -> holder.value())
                .toList());
        registration.addRecipes(purifierRecipeCategory.getRecipeType(), recipeManager.getAllRecipesFor(ChangedRecipeTypes.PURIFIER_RECIPE.get()).stream()
                .map(holder -> holder.value())
                .toList());
    }
