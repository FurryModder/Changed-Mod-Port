...
import net.changed.client.ModelPartStem;
import net.changed.client.renderer.model.AdvancedHumanoidModel;
import net.changed.client.renderer.model.TorsoedModel;
...
public class LatexDripParticle extends LatexParticle {
    ...
    public void render(VertexConsumer buffer, Camera camera, float partialTicks) {
        ...
        if (Changed.config.client.renderDripParticlesWithNormal.get()) {
            ...
            buffer.addVertex(genVec[0].x(), genVec[0].y(), genVec[0].z()).setColor(this.color.red(), this.color.green(), this.color.blue(), this.alpha).setUv(u1, v1)
                    .setOverlay(overlay).setLight(lightColor).setNormal(normX, normY, normZ);
            buffer.addVertex(genVec[1].x(), genVec[1].y(), genVec[1].z()).setColor(this.color.red(), this.color.green(), this.color.blue(), this.alpha).setUv(u1, v0)
                    .setOverlay(overlay).setLight(lightColor).setNormal(normX, normY, normZ);
            buffer.addVertex(genVec[2].x(), genVec[2].y(), genVec[2].z()).setColor(this.color.red(), this.color.green(), this.color.blue(), this.alpha).setUv(u0, v0)
                    .setOverlay(overlay).setLight(lightColor).setNormal(normX, normY, normZ);
            buffer.addVertex(genVec[3].x(), genVec[3].y(), genVec[3].z()).setColor(this.color.red(), this.color.green(), this.color.blue(), this.alpha).setUv(u0, v1)
                    .setOverlay(overlay).setLight(lightColor).setNormal(normX, normY, normZ);
        } else {
            buffer.addVertex(genVec[0].x(), genVec[0].y(), genVec[0].z()).setUv(u1, v1).setColor(this.color.red(), this.color.green(), this.color.blue(), this.alpha)
                    .setLight(lightColor);
            buffer.addVertex(genVec[1].x(), genVec[1].y(), genVec[1].z()).setUv(u1, v0).setColor(this.color.red(), this.color.green(), this.color.blue(), this.alpha)
                    .setLight(lightColor);
            buffer.addVertex(genVec[2].x(), genVec[2].y(), genVec[2].z()).setUv(u0, v0).setColor(this.color.red(), this.color.green(), this.color.blue(), this.alpha)
                    .setLight(lightColor);
            buffer.addVertex(genVec[3].x(), genVec[3].y(), genVec[3].z()).setUv(u0, v1).setColor(this.color.red(), this.color.green(), this.color.blue(), this.alpha)
                    .setLight(lightColor);
        }
    }
