...
import static net.changed.client.renderer.animate.upperbody.OrcaUpperBodySwimAnimator.SWIM_SCALE;
import static net.changed.client.renderer.animate.upperbody.SharkUpperBodySwimAnimator.*;
