package net.changed.client.renderer.animate;

import net.changed.client.renderer.animate.arm.*;
import net.changed.client.renderer.animate.armsets.*;
import net.changed.client.renderer.animate.bipedal.*;
import net.changed.client.renderer.animate.camera.DragonCameraCreativeFlyAnimator;
import net.changed.client.renderer.animate.camera.OrcaCameraSwimAnimator;
import net.changed.client.renderer.animate.camera.SharkCameraSwimAnimator;
import net.changed.client.renderer.animate.camera.TaurCameraJumpAnimator;
import net.changed.client.renderer.animate.ears.BeeAntennaeInitAnimator;
import net.changed.client.renderer.animate.ears.CatEarsInitAnimator;
import net.changed.client.renderer.animate.ears.WolfEarsInitAnimator;
import net.changed.client.renderer.animate.legless.*;
import net.changed.client.renderer.animate.misc.SquidDogTentaclesBobAnimator;
import net.changed.client.renderer.animate.misc.SquidDogTentaclesInitAnimator;
import net.changed.client.renderer.animate.misc.SquidDogTentaclesSwimAnimator;
import net.changed.client.renderer.animate.quadrupedal.*;
import net.changed.client.renderer.animate.tail.*;
import net.changed.client.renderer.animate.upperbody.*;
import net.changed.client.renderer.animate.wing.*;
