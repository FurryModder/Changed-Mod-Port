...
import net.changed.client.renderer.model.LatexHumanModel;
import net.changed.client.renderer.model.armor.ArmorHumanModel;
import net.changed.entity.BasicPlayerInfo;
import net.changed.entity.beast.DarkLatexWolfPartial;
import net.changed.entity.beast.LatexHuman;
