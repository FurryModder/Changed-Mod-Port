    ...
    public void render(PoseStack p_116951_, MultiBufferSource p_116952_, int p_116953_, T p_116954_, float p_116955_, float p_116956_, float p_116957_, float p_116958_, float p_116959_, float p_116960_) {
        ...
        if (shouldRender(itemstack, p_116954_)) {
            ...
            if (p_116954_.getUnderlyingPlayer() instanceof AbstractClientPlayer clientPlayer) {
                if (clientPlayer.getSkin().elytraTexture() != null) {
                    resourcelocation = clientPlayer.getSkin().elytraTexture();
                } else if (clientPlayer.getSkin().capeTexture() != null && TransfurCapeLayer.getCloakTextureLocation(p_116954_) != null && clientPlayer.isModelPartShown(PlayerModelPart.CAPE)) {
            ...
            this.elytraModel.renderToBuffer(p_116951_, vertexconsumer, p_116953_, OverlayTexture.NO_OVERLAY, -1);
            p_116951_.popPose();
        }
    }
