...
In *src/main/java/net/changed/entity/beast* create a new Java class for your entity.
...
## Entity renderer
Now you'll need a renderer for your entity. In *src/main/java/net/changed/client/renderer*, copy yourself a new renderer class.
...
## We're not done here.
If you are meant to be able to transfur into this entity, add a new entry for your entity in *src/main/java/net/changed/entity/variant/LatexVariant.java*.
```java
