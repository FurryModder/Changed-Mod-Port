...
import net.changed.client.renderer.animate.arm.DoubleArmBobAnimator;
import net.changed.client.renderer.animate.multihead.TripleHeadAnimator;
import net.changed.client.renderer.animate.upperbody.WolfHeadInitAnimator;
import net.changed.client.renderer.model.DoubleArmedModel;
import net.changed.client.renderer.model.TripleHeadedModel;
...
public class ArmorPureWhiteLatexCerberusModel<T extends ChangedEntity & TripleHeadedEntity> extends LatexHumanoidArmorModel<T, ArmorPureWhiteLatexCerberusModel<T>> implements TripleHeadedModel<T>, DoubleArmedModel<T> {
    ...
    public void renderForSlot(T entity, RenderLayerParent<? super T, ?> parent, ItemStack stack, EquipmentSlot slot, PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        ...
        switch (slot) {
            case HEAD -> HeadRow.render(poseStack, buffer, packedLight, packedOverlay, net.minecraft.util.FastColor.ARGB32.colorFromFloat(alpha, red, green, blue));
            case CHEST -> {
                ...
                UpperLeftArm.render(poseStack, buffer, packedLight, packedOverlay, net.minecraft.util.FastColor.ARGB32.colorFromFloat(alpha, red, green, blue));
                UpperRightArm.render(poseStack, buffer, packedLight, packedOverlay, net.minecraft.util.FastColor.ARGB32.colorFromFloat(alpha, red, green, blue));
            }
            case LEGS -> {
                Torso.render(poseStack, buffer, packedLight, packedOverlay, net.minecraft.util.FastColor.ARGB32.colorFromFloat(alpha, red, green, blue));
                LeftLeg.render(poseStack, buffer, packedLight, packedOverlay, net.minecraft.util.FastColor.ARGB32.colorFromFloat(alpha, red, green, blue));
                RightLeg.render(poseStack, buffer, packedLight, packedOverlay, net.minecraft.util.FastColor.ARGB32.colorFromFloat(alpha, red, green, blue));
            }
            case FEET -> {
                LeftLeg.render(poseStack, buffer, packedLight, packedOverlay, net.minecraft.util.FastColor.ARGB32.colorFromFloat(alpha, red, green, blue));
                RightLeg.render(poseStack, buffer, packedLight, packedOverlay, net.minecraft.util.FastColor.ARGB32.colorFromFloat(alpha, red, green, blue));
