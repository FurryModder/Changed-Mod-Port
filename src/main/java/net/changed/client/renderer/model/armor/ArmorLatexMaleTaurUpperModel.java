...
public class ArmorLatexMaleTaurUpperModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorLatexMaleTaurUpperModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorLatexMaleTaurUpperModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_latex_male_taur_upper"), ArmorLatexMaleTaurUpperModel::createArmorLayer, ArmorLatexMaleTaurUpperModel::new);

    private final ModelPart RightArm;
    private final ModelPart LeftArm;
    private final ModelPart Head;
    private final ModelPart Torso;
    private final HumanoidAnimator<T, ArmorLatexMaleTaurUpperModel<T>> animator;

    public ArmorLatexMaleTaurUpperModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorLatexMaleTaurUpperModel<T>> getAnimator(T entity) {
        return animator;
    }
