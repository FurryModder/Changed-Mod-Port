...
public class ArmorBuffMermaidSharkUpperBodyModel<T extends ChangedEntity> extends LatexHumanoidArmorModel<T, ArmorBuffMermaidSharkUpperBodyModel<T>> {
    public static final ArmorModelSet<ChangedEntity, ArmorBuffMermaidSharkUpperBodyModel<ChangedEntity>> MODEL_SET =
            ArmorModelSet.of(Changed.modResource("armor_buff_mermaid_shark_upper"), ArmorBuffMermaidSharkUpperBodyModel::createArmorLayer, ArmorBuffMermaidSharkUpperBodyModel::new);

    private final ModelPart Head;
    private final ModelPart Torso;
    private final ModelPart LeftArm;
    private final ModelPart RightArm;
    private final HumanoidAnimator<T, ArmorBuffMermaidSharkUpperBodyModel<T>> animator;

    public ArmorBuffMermaidSharkUpperBodyModel(ModelPart modelPart, ArmorModel model) {
    ...
    @Override
    public HumanoidAnimator<T, ArmorBuffMermaidSharkUpperBodyModel<T>> getAnimator(T entity) {
        return animator;
    }
