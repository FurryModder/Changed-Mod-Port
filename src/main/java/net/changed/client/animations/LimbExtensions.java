package net.changed.client.animations;

import com.google.common.collect.ImmutableMap;
import com.mojang.serialization.Codec;
import com.mojang.serialization.DataResult;
import net.changed.Changed;
import net.changed.client.renderer.animate.legless.AbstractLeglessAnimator;
import net.changed.client.renderer.animate.tail.AbstractTailAnimator;
import net.changed.client.renderer.animate.wing.AbstractWingAnimatorV2;
import net.changed.client.renderer.animate.wing.BeeWingInitAnimator;
...
public class LimbExtensions {
    ...
    public static void gatherExtensions() {
        if (hasRunEvent)
            return;
        Changed.postModLoadingEvent(new GatherExtensionsEvent(EXTENSIONS));
        hasRunEvent = true;
    }
