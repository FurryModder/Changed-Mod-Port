...
import net.changed.item.TscWeapon;
...
public class RecipeCategories {
    ...
    private static RecipeBookCategories registerBookCategory(String name) {
        var category = RecipeBookCategories.valueOf(name);
    ...
    public static final RecipeBookCategories INFUSER_SEARCH = registerBookCategory("CHANGED_INFUSER_SEARCH");
    public static final RecipeBookCategories INFUSER_DARK_LATEX = registerBookCategory("CHANGED_INFUSER_DARK_LATEX");
    public static final RecipeBookCategories INFUSER_WHITE_LATEX = registerBookCategory("CHANGED_INFUSER_WHITE_LATEX");
    public static final RecipeBookCategories INFUSER_AQUATIC = registerBookCategory("CHANGED_INFUSER_AQUATIC");
    public static final RecipeBookCategories INFUSER_AERIAL = registerBookCategory("CHANGED_INFUSER_AERIAL");
    ...
    public static class GatherVariantCategoriesEvent extends Event implements IModBusEvent {
        ...
        public void add(RecipeBookCategories category, DeferredHolder<TransfurVariant<?>, ? extends TransfurVariant<?>> delegate) {
        ...
        public void addDarkLatex(DeferredHolder<TransfurVariant<?>, ? extends TransfurVariant<?>> delegate) {
        ...
        public void addWhiteLatex(DeferredHolder<TransfurVariant<?>, ? extends TransfurVariant<?>> delegate) {
        ...
        public void addAquatic(DeferredHolder<TransfurVariant<?>, ? extends TransfurVariant<?>> delegate) {
        ...
        public void addAerial(DeferredHolder<TransfurVariant<?>, ? extends TransfurVariant<?>> delegate) {
        ...
        public void addGendered(DeferredHolder<TransfurVariant<?>, ? extends TransfurVariant<?>> delegate) {
