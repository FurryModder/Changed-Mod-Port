...
import net.changed.network.packet.debugger.FacilityAddPiecesPayload;
...
public class ChangedPackets {
    ...
    public void registerPackets() {
        ...
        addNetworkMessage(KeypadCodePacket.class, KeypadCodePacket::new);
        addNetworkMessage(StasisChamberControlPacket.class, StasisChamberControlPacket::new);
