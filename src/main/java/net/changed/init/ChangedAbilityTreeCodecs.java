...
import net.changed.ability.tree.*;
import net.changed.ability.tree.condition.*;
...
public class ChangedAbilityTreeCodecs {
     ...
     */
    public static final DeferredHolder<Codec<? extends AbilityTree.NodeEffect>, Codec<GroupNodeEffect>> GROUP_EFFECT = NODE_EFFECT_REGISTRY.register("group", () -> GroupNodeEffect.CODEC);
    /**
     ...
     */
    public static final DeferredHolder<Codec<? extends AbilityTree.NodeEffect>, Codec<ToggleGroupNodeEffect>> TOGGLE_GROUP_EFFECT = NODE_EFFECT_REGISTRY.register("active/toggle_group", () -> ToggleGroupNodeEffect.CODEC);
    /**
     * Adds a scalar to the specified attribute in the entity. Can be positive or negative.
     */
    public static final DeferredHolder<Codec<? extends AbilityTree.NodeEffect>, Codec<AttributeModifierNodeEffect>> ATTRIBUTE_MODIFIER_EFFECT = NODE_EFFECT_REGISTRY.register("attribute_modifier", () -> AttributeModifierNodeEffect.CODEC);
    /**
     * Applies a MobEffect to the entity.
     */
    public static final DeferredHolder<Codec<? extends AbilityTree.NodeEffect>, Codec<MobEffectNodeEffect>> MOB_EFFECT_EFFECT = NODE_EFFECT_REGISTRY.register("mob_effect", () -> MobEffectNodeEffect.CODEC);
    /**
     ...
     */
    public static final DeferredHolder<Codec<? extends AbilityTree.NodeEffect>, Codec<CreateItemAbilityNodeEffect>> CREATE_ITEM_ABILITY_EFFECT = NODE_EFFECT_REGISTRY.register("active/create_item_effect", () -> CreateItemAbilityNodeEffect.CODEC);
     ...
     */
    public static final DeferredHolder<Codec<? extends AbstractCondition>, Codec<TrueCondition>> TRUE_CONDITION = EFFECT_CONDITION_REGISTRY.register("true", () -> TrueCondition.CODEC);
    /**
     * Only resolves to `true` if all sub conditions resolve to `true`, or if this has no sub conditions.
     */
    public static final DeferredHolder<Codec<? extends AbstractCondition>, Codec<AllCondition>> ALL_CONDITION = EFFECT_CONDITION_REGISTRY.register("all", () -> AllCondition.CODEC);
    /**
     * Resolves to `true` if any of the sub conditions resolve to `true`. Resolves to `false` if this has no sub conditions.
     */
    public static final DeferredHolder<Codec<? extends AbstractCondition>, Codec<AnyCondition>> ANY_CONDITION = EFFECT_CONDITION_REGISTRY.register("any", () -> AnyCondition.CODEC);
    /**
     ...
     */
    public static final DeferredHolder<Codec<? extends AbstractCondition>, Codec<NoneCondition>> NONE_CONDITION = EFFECT_CONDITION_REGISTRY.register("none", () -> NoneCondition.CODEC);
    /**
     ...
     */
    public static final DeferredHolder<Codec<? extends AbstractCondition>, Codec<NthTickCondition>> NTH_TICK_CONDITION = EFFECT_CONDITION_REGISTRY.register("nth_tick", () -> NthTickCondition.CODEC);
    /**
     * Resolves to `true` if the entity is standing on a block that matches any of the given predicates (exact ID, block tag)
     */
    public static final DeferredHolder<Codec<? extends AbstractCondition>, Codec<StandingOnCondition>> STANDING_ON_CONDITION = EFFECT_CONDITION_REGISTRY.register("standing_on", () -> StandingOnCondition.CODEC);
    /**
     ...
     */
    public static final DeferredHolder<Codec<? extends AbstractCondition>, Codec<InFluidCondition>> IN_FLUID_CONDITION = EFFECT_CONDITION_REGISTRY.register("in_fluid", () -> InFluidCondition.CODEC);
    /**
     ...
     */
    public static final DeferredHolder<Codec<? extends AbstractCondition>, Codec<LightExposureCondition>> LIGHT_EXPOSURE_CONDITION = EFFECT_CONDITION_REGISTRY.register("light_exposure", () -> LightExposureCondition.CODEC);
}
