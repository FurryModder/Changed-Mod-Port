...
public class ChangedTabs {
    ...
    private static DeferredHolder<CreativeModeTab, CreativeModeTab> register(String id, Function<CreativeModeTab.Builder, CreativeModeTab> finalizer) {
    ...
    public static DeferredHolder<CreativeModeTab, CreativeModeTab> TAB_CHANGED_BLOCKS = register("blocks", builder ->
            builder.icon(() -> new ItemStack(ChangedBlocks.WALL_LIGHTRED_STRIPED.get()))
                    .displayItems((params, output) -> {
                        ...
                        ChangedBlocks.PILLOWS.values().stream().map(Supplier::get).forEach(output::accept);

                         params.holders().lookupOrThrow(Registries.PAINTING_VARIANT).listElements()
                                 .filter(variant -> variant.key().location().getNamespace().equals(Changed.MODID))
                                 .forEach(variant -> {
                                     ItemStack stack = new ItemStack(Items.PAINTING);
                                     CompoundTag compoundtag = new CompoundTag();
                                     compoundtag.putString("id", "minecraft:painting");
                                     compoundtag.putString("variant", variant.key().location().toString());
                                     stack.set(DataComponents.ENTITY_DATA, CustomData.of(compoundtag));
                                     output.accept(stack);
                                 });
                    }).build());

    public static DeferredHolder<CreativeModeTab, CreativeModeTab> TAB_CHANGED_ITEMS = register("items", builder ->
    ...
    public static DeferredHolder<CreativeModeTab, CreativeModeTab> TAB_CHANGED_ENTITIES = register("entities", builder ->
    ...
    public static DeferredHolder<CreativeModeTab, CreativeModeTab> TAB_CHANGED_COMBAT = register("combat", builder ->
    ...
    public static DeferredHolder<CreativeModeTab, CreativeModeTab> TAB_CHANGED_CLOTHING = register("clothing", builder ->
    ...
    public static DeferredHolder<CreativeModeTab, CreativeModeTab> TAB_CHANGED_MUSIC = register("music", builder ->
