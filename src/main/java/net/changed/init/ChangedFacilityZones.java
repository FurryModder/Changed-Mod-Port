...
public class ChangedFacilityZones {
    ...
    private static DeferredHolder<Zone, Zone> registerZone(String name, BiFunction<IForgeRegistry<Biome>, ResourceLocation, Zone> ctor) {
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> GENERAL_ZONE = registerZone("general", Zone.anyBiome(false, 1));
    /**
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> SERVER_ZONE = registerZone("server", Zone.anyBiome(true, 3));
    /**
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> OFFICE_ZONE = registerZone("office", Zone.anyBiome(true, 4));
    /**
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> DARK_LATEX_ZONE = registerZone("dark_latex", Zone.anyBiome(true, 2));
    /**
     * Books.
     * <ul>
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> LIBRARY_ZONE = registerZone("library", Zone.anyBiome(true, 3));
    /**
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> VENT_ZONE = registerZone("vent", Zone.anyBiome(true, 2));
    /**
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> GREENHOUSE_ZONE = registerZone("greenhouse", Zone.anyBiome(true, 3));
    /**
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> MAINTENANCE_ZONE = registerZone("maintenance", Zone.anyBiome(true, 4));
    /**
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> WHITE_LATEX_ZONE = registerZone("white_latex", Zone.anyBiome(true, 2));
    /**
     ...
     * </ul>
     */
    public static final DeferredHolder<Zone, Zone> ENTRANCE_ZONE = registerZone("entrance", Zone.anyBiome(true, 4));
}
