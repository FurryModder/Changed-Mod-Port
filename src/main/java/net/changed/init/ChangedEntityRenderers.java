...
import net.changed.client.RegisterComplexRenderersEvent;
import net.changed.client.renderer.*;
import net.changed.client.renderer.particle.GasParticleRenderer;
...
public class ChangedEntityRenderers {
    ...
    public static void registerComplexEntityRenderers(RegisterComplexRenderersEvent event) {
        ...
        event.registerEntityRenderer(ChangedEntities.DARK_LATEX_WOLF_PARTIAL.get(), "wide", DarkLatexWolfPartialRenderer.forModelSize(false));
        ...
        event.registerEntityRenderer(ChangedEntities.LATEX_HUMAN.get(), "wide", LatexHumanRenderer.forModelSize(false));
