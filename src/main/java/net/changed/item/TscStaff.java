...
public class TscStaff extends TscWeapon implements SpecializedItemRendering, SpecializedAnimations {
    ...
    private static final ResourceLocation STAFF_IN_HAND = Changed.modResource("item/tsc_staff_in_hand");

    @Override
    public ResourceLocation getModelLocation(ItemStack itemStack, ItemDisplayContext type) {
        return SpecializedItemRendering.isGUI(type) ? null : STAFF_IN_HAND;
    }
