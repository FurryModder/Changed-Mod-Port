package net.changed.mixin.compatibility.Personality;
...
public abstract class HumanoidAnimatorMixin<T extends ChangedEntity, M extends AdvancedHumanoidModel<T>> {
    @WrapOperation(method = "setupVariables", at = @At(value = "INVOKE", target = "Lnet/changed/client/renderer/model/AdvancedHumanoidModel;shouldModelSit(Lnet/changed/entity/ChangedEntity;)Z"))
